...
import {getAllEmployees, getAllTasksAdmin } from "../api";
    ...
    <Container>
      {loading || error ? (
        ...
        <div>
          <Wrapper> 
            <Button>
                <TaskButton onClick={() => setOpenCreateTask(true)}>
      ...
      {openCreateTask && <CreateTaskAdmin setOpenCreateTask={setOpenCreateTask} employees={employees}/>}
    </Container>
  );
};
